...
if __name__ == '__main__':
    ...
    if not os.path.exists('/content/drive/MyDrive/ColorLab/output'):          
            os.mkdir('/content/drive/MyDrive/ColorLab/output')  
    ...
    if ep.lol:
        ...
        output_folder = '/content/drive/MyDrive/ColorLab/output/LOLv1/'
        if ep.perc:
            weight_path = '/content/drive/MyDrive/ColorLab/weights/LOLv1/w_perc.pth'
        else:
            weight_path = '/content/drive/MyDrive/ColorLab/weights/LOLv1/wo_perc.pth'
