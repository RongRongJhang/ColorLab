...
def train(epoch):
    ...
    for batch in tqdm(training_data_loader):
        ...
        gt_rgb = im2
        output_hvi = model.OKLabT(output_rgb)
        gt_hvi = model.OKLabT(gt_rgb)
...
def checkpoint(epoch):
    if not os.path.exists("/content/drive/MyDrive/ColorLab/weights"):          
        os.mkdir("/content/drive/MyDrive/ColorLab/weights") 
    if not os.path.exists("/content/drive/MyDrive/ColorLab/weights/train"):          
        os.mkdir("/content/drive/MyDrive/ColorLab/weights/train")  
    model_out_path = "/content/drive/MyDrive/ColorLab/weights/train/epoch_{}.pth".format(epoch)
...
def build_model():
    ...
    if opt.start_epoch > 0:
        pth = f"/content/drive/MyDrive/ColorLab/weights/train/epoch_{opt.start_epoch}.pth"
...
if __name__ == '__main__':  
    ...
    with open(f"/content/drive/MyDrive/ColorLab/results/training/metrics{now}.md", "w") as f:
